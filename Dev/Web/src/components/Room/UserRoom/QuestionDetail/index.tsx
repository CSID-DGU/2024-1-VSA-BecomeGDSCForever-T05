        ...
        <Row>
            <Padding all={"20px"} backgroundColor={theme.colorSystem.white}
                ...
                <Styled.Container>
                    ...
                    <SizedBox height={"12px"}/>
                    <H6 text={props.dialogueDetail.answer ? `${calculateTime(convertStringToDate(props.dialogueDetail.answeredAt))} 답변` : `${calculateTime(convertStringToDate(props.dialogueDetail.askedAt))} 질문`}
